...
class Ui_bpui(object):
    ...
    def retranslateUi(self, bpui):
        ...
        self.clfConf.setText(_translate("bpui", "   ", None))
        ...
        self.cvConf.setText(_translate("bpui", "   ", None))
